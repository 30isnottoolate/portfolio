...
const Portfolio: React.FC = () => {
	...
	return (
		<div id="portfolio">
			...
			/>
			<a href="#welcome" className={scrollPos > 1300 ? "visible" : "invisible"} style={{ position: "fixed", bottom: "30px", right: "40px" }}>
				<svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="#80b9ff" stroke="#000f20" strokeWidth="0.1" viewBox="0 0 16 16">
